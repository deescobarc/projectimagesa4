                                        ...
                                        <div class="grid grid-cols-6 gap-4 px-4 py-5 bg-white sm:p-6">
                                            <div class="col-start-2 col-span-4">
                                                ...
                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                    ...
                                                    <input type="text" name="name" id="name" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="Ingrese un nombre para la imagen" required>
                                                </div>
                                            </div>
                                            <div class="col-start-2 col-span-4">
